...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'geometry_comparator_dialog_base.ui'))


class GeometryComparatorDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(GeometryComparatorDialog, self).__init__(parent)
